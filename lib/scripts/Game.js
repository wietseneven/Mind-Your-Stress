...
stressGame.prototype = {
	...
	init: function () {
		...
		this.world.resize(dim.w*5, dim.h);
	...
	preload: function () {
		...
		this.load.baseURL = 'lib/images/scenes/home/';
		this.load.crossOrigin = 'anonymous';

		this.load.image('skyline', 'skyline.png');
		this.load.image('background', 'background.png');
		this.load.image('platform', 'platform.png');
		this.load.image('cloud-platform', 'cloud-platform.png');
		this.load.spritesheet('dude', 'dude.png', 64, 96);
	...
	update: function () {
		...
		if (this.cursors.left.isDown) {
			// action if left key is pressed
		} else if (this.cursors.right.isDown)	{
			// action if right key is pressed
		}
