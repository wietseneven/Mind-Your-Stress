...
stress.levelSelect.prototype = {
	create: function() {
		...
		var bannerHome = this.game.add.image(0,0,"menu_banner-tutorial");
		...
		var buildingHome = this.game.add.image(0,0,"menu_building-tutorial");
		...
		var buttonTutorial = this.game.add.button(this.game.width / 2 - 106, stress.game.height - 78, 'menu_button-start', this.startLevel1, this, 0, 0, 1);
