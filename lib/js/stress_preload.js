...
stress.Preload.prototype = {
	preload: function() {
		...
		this.load.image('menu_btn-start', baseImage_src + 'menu/menu_btn-start.png');

		// level
		this.load.spritesheet('level_move', baseImage_src + 'levels/level_move.png', 130, 131);
		this.load.spritesheet('level_jump', baseImage_src + 'levels/level_jump.png', 130, 131);
		this.load.spritesheet('level_restart', baseImage_src + 'levels/level_restart.png', 130, 131);
