...
stress.Preload.prototype = {
	preload: function() {
		...
		this.load.spritesheet('level_male_dude', baseImage_src + 'levels/common/male_dude_spritesheet.png', 245.5, 400);
		this.load.spritesheet('level_female_dude', baseImage_src + 'levels/common/female_dude_spritesheet.png', 245.5, 400);
