...
stress.Preload.prototype = {
	preload: function() {
		...
		// level
		this.load.spritesheet('level_move', baseImage_src + 'levels/buttons/level_forward.png', 95, 98);
		this.load.spritesheet('level_jump', baseImage_src + 'levels/buttons/level_jump.png', 95, 98);
		this.load.spritesheet('level_restart', baseImage_src + 'levels/buttons/level_restart.png', 95, 96);
