...
stress.Preload.prototype = {
	preload: function() {
		...
		this.load.image('menu_banner-tutorial', baseImage_src + 'levels/common/level_banner_thuis.png');
		...
		this.load.image('menu_building-tutorial', baseImage_src + 'levels/common/level_carousel_thuis.png');
