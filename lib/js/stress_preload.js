...
stress.Preload.prototype = {
	preload: function() {
		...
		this.load.spritesheet('bedroom-dude', baseImage_src + 'levels/bedroom/dude.png', 64, 96);
		this.load.spritesheet('bedroom-laundryBin', baseImage_src + 'levels/bedroom/wasmand-sprite.png');
