...
stress.Preload.prototype = {
	preload: function() {
		...
		// level
		this.load.spritesheet('level_move', baseSRC + 'levels/level_move.png', 130, 131);
		this.load.spritesheet('level_jump', baseSRC + 'levels/level_jump.png', 130, 131);
		this.load.spritesheet('level_restart', baseSRC + 'levels/level_restart.png', 130, 131);
