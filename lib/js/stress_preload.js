...
stress.Preload.prototype = {
	preload: function() {
		...
		//menu locked
		this.load.image('level_locked', baseImage_src + 'levels/algemeen/level_locked.png');
		//settings
		...
		this.load.spritesheet('level_male_dude', baseImage_src + 'levels/algemeen/male_dude_spritesheet.png', 245.5, 400);
		this.load.spritesheet('level_female_dude', baseImage_src + 'levels/algemeen/female_dude_spritesheet.png', 245.5, 400);
