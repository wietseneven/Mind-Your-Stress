...
stress.MainMenu.prototype = {
	create: function() {
		...
		var levelUno = this.game.add.button(stress.game.width / 2 - 160, stress.game.height / 2 + 25, 'menu_levels', this.startLevel1, this, 0, 0, 0);
		levelUno.scale.setTo(0.8);
		levelUno.anchor.setTo(0.5);

		var levelDos = this.game.add.button(stress.game.width / 2 - 80, stress.game.height / 2 + 25, 'menu_levels', this.startLevel2, this, 1, 1, 1);
		levelDos.scale.setTo(0.8);
		levelDos.anchor.setTo(0.5);

		var levelTres = this.game.add.button(stress.game.width / 2 , stress.game.height / 2 + 25, 'menu_levels', this.startLevel3, this, 2, 2, 2);
		levelTres.scale.setTo(0.8);
		levelTres.anchor.setTo(0.5);

		var levelCuatro = this.game.add.button(stress.game.width / 2 + 80, stress.game.height / 2 + 25, 'menu_levels', this.startLevel4, this, 3, 3, 3);
		levelCuatro.scale.setTo(0.8);
		levelCuatro.anchor.setTo(0.5);

		var levelCinco = this.game.add.button(stress.game.width / 2 + 160, stress.game.height / 2 + 25, 'menu_levels', this.startLevel5, this, 4, 4, 4);
		levelCinco.scale.setTo(0.8);
		levelCinco.anchor.setTo(0.5);
