...
level_sport = {
	...
	messages: function(level) {
		level.introtext = level.add.sprite(210, level.game.height - 460, 'sport-intro');
	...
	horde: function(level, x) {
		var books = level.add.sprite(x, stress.game.height - level.platformTop - 115, 'sport-horde');
