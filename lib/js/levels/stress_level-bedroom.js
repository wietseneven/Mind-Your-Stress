...
level_bedroom = {
	...
	images: function(level) {
		...
		level.introtext = level.add.sprite(250, level.game.height - 340, 'bedroom-intro');
		...
		level.thoughLife = level.add.sprite(250, level.game.height - 320, 'level_notify-thoughlife');
	...
	laundryBin: function(level, x) {
		var bin = level.add.sprite(x, stress.game.height - 190, 'bedroom-laundryBin');
